...
Compare Cortisol and Cortison extensivly. Use tools described in https://github.com/chatelao/ai-tooling
to build a nice desciption using chemical formulas and 3D rendered molecules.
