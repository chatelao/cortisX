...
2. \textbf{Rezeptorbindung}: Im Zytoplasma bindet Cortisol an den \textbf{Glucocorticoid-Rezeptor (GR)}, der normalerweise durch einen Chaperon-Komplex, bestehend aus \textbf{HSP90}, \textbf{HSP70} und \textbf{FKBP5} (das die Bindungsaffinität reduziert), in einem inaktiven Zustand gehalten wird.
3. \textbf{Aktivierung}: Die Bindung löst die Dissoziation dieser Chaperon-Proteine aus. Dabei wird FKBP5 oft durch \textbf{FKBP4} ersetzt, was die Konformationsänderung unterstützt und die Bindungsaffinität erhöht.
4. \textbf{Nukleare Translokation}: Der aktivierte Cortisol-GR-Komplex transloziert in den Zellkern, wobei FKBP4 die Interaktion mit dem Dynein-Transportprotein vermittelt.
