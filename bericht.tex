...
Die Umwandlung von Cortison in Cortisol wird durch das Enzym \textbf{11\texorpdfstring{$\beta$}{beta}-Hydroxysteroid-Dehydrogenase Typ 1 (11\texorpdfstring{$\beta$}{beta}-HSD1)} vermittelt, das sich hauptsächlich in der Leber befindet, aber auch in anderen Geweben wie dem Fettgewebe und dem Gehirn vorkommt.
